						...
						<div class="col-xs-12 col-sm-12 col-md-8 top-search-holder">
							...
							<div class="search-area">
								<div class="control-group">
									<form method="get" action="./selectget.php">
								...
								<nav class="yamm megamenu-horizontal" role="navigation">
									<ul class="nav">
										<li class="dropdown menu-item">
											<a href="selectget.php?searchterm=Footballs" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i>Footballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="selectget.php?searchterm=Volleyballs" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i>Volleyballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="selectget.php?searchterm=Basketballs" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i>Basketballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="selectget.php?searchterm=Foods" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i>Foods</a>
										</li>
									</ul>
								</nav>
							</div>
						...
						<div class="col-md-9">
							<?php
								...
								if (isset($_GET['searchterm']))
								{
									...
									'date' => date("Y-m-d"),
									'problemid' => $problemid,
									'problemname' => 'Select(get)',
									'problemstatus' => $objectiveresult
									);
									curl_logactivity($data);
									$_SESSION["logactivity"] = $_SESSION['uniquekey']." ".date("Y-m-d")." ".$objectiveresult." "."Select(get)";
									$conn->close();
								}
							?>
						</div>
