...
// create connection
	...
	$sql = "select * from problemtable where problemid=19";
				...
				<div class="col-md-9 body-content cnt-home" style="border-left: 1px solid black;">
					...
					<div class="row sign-in-page">
						...
						<div class="col-md-6 col-sm-6 sign-in">
							<h4 class="">sign in</h4>
							<p class="">Hello, please login to your account (onetime username and password is: jim/jam).</p>
						...
						<div class="col-md-8">
							<?php
								if(isset($_POST['userlogin']) && isset($_POST['userpwd']))
								{
									...
									if(($username == 'jim') && ($userpwd == 'jam'))
									{
										echo $message =  "<font color=green><p>login successful Welcome </p></font>";
										$objectiveresult = "Successful login";
										
										$_SESSION["login"] = $username;
										$ba_ll_token = sha1(uniqid(mt_rand(0,100000)));
										$_SESSION["ba_ll_token"] = $ba_ll_token;
									}
									else
									{
