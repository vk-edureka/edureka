...
// create connection
	...
	$sql = "select * from problemtable where problemid=1";
...
<html>
	<head>
		<title>Hack Me - Search (Get) Injection</title>
			...
			<div class="row">
				...
				<div class="col-md-9" style="border-left: 1px solid black;">
					...
					<div class="row main-header">
						<div class="col-md-3">
							<h2 style="text-align: left;">WELCOME TO BALL STORE</h2>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-8 top-search-holder">
							<br><br>								
							<div class="search-area">
								<div class="control-group">
									<form method="get" action="./searchget.php">
										<input class="search-field" placeholder="Search here for basketballs, footballs, volleyballs..." name="searchterm" id="searchterm" style="height:10px;font-size:10pt;"/>
					...
					<div class="row">
								...
								<nav class="yamm megamenu-horizontal" role="navigation">
									<ul class="nav">
										<li class="dropdown menu-item">
											<a href="searchget.php?searchterm=Footballs" class="dropdown-toggle"><i class="icon fa fa-futbol-o fa-fw"></i>Footballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="searchget.php?searchterm=Volleyballs" class="dropdown-toggle"><i class="icon fa fa-hand-o-up fa-fw"></i>Volleyballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="searchget.php?searchterm=Basketballs" class="dropdown-toggle"><i class="icon fa fa-send-o fa-fw"></i>Basketballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="searchget.php?searchterm=Foods" class="dropdown-toggle"><i class="icon fa fa-spoon fa-fw"></i>Foods</a>
										</li>
									</ul>
								</nav>
							</div>
						...
						<div class="col-md-9">							
							<?php
								...
								{
									$whereclause .= " and it.itemtype like '" . $itemtype . "'";
								}
								...
								{
									$objectiveresult ="input contains some restricted sql command";
								}
								else
								{
									$itemtypecode =$conn->query("select itemtypecode from itemtypes where itemtype = '" . ucwords($itemtype) ."'");
									$result = $conn->query($sql);
								...
								'date' => date("Y-m-d"),
								'problemid' => $problemid,
								'problemname' => 'Search(get)',
								'problemstatus' => $objectiveresult
								
								);
								curl_logactivity($data);
								$_SESSION["logactivity"] = $_SESSION['uniquekey']." ".date("Y-m-d")." ".$objectiveresult." "."Search(get)";
								$conn->close();
