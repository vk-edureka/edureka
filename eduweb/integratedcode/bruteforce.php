...
// create connection
	...
	$sql = "select * from problemtable where problemid=10";
						...
						<div class="col-md-8">
							<?php
								if(isset($_POST['userlogin']) && isset($_POST['userpwd']))
								{
									...
									if (($username == $bforce_name) && ($userpwd == $bforce_value))
									{
									...
									'date' => date("Y-m-d"),
									'problemid' => $problemid,
									'problemname' => 'Bruteforce',
									'problemstatus' => $objectiveresult
									);
									curl_logactivity($data);
									$_SESSION["logactivity"] = $_SESSION['uniquekey']." ".date("Y-m-d")." ".$objectiveresult." "."Bruteforce";
								}
							?>
