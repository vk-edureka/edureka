...
// create connection
	...
	$sql = "select * from problemtable where problemid=17";
				...
				<div class="col-md-3" style="padding-left: 10px;height: 100%;border-right: 1px solid black;">
					...
					<div class="row">
						<div class="col-md-12">
								...
								<p>Enter the username and password separated by =</p>
							...
							<form class="register-form" method="post" onsubmit="return TryToLogin()">
								<div class="row" style="padding: 30px;">						
									<div class="form-group" style="align: center;">
										...
										<div class="row">
											<input type="hidden" name="pwd" id="pwd" value="<?php echo $pwdvalue; ?>" />
										</div>
									</div>
								</div>
							...
							<?php
								if(isset($_POST['userlogin']) && isset($_POST['userpwd']))
								{
									...
									if ($userpwd == $pwdvalue)
									{
										...
										echo "<font color=green>welcome (".$username.") Successful login</font>";
									}
									else
									{
									...
									'date' => date("Y-m-d"),
									'problemid' => $problemid,
									'problemname' => 'ba_passwordattack',
									'problemstatus' => $objectiveresult
									);
									curl_logactivity($data);
									$_SESSION["logactivity"] = $_SESSION['uniquekey']." ".date("Y-m-d")." ".$objectiveresult." "."ba_passwordattack";
								}
							?>
