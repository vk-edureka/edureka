...
// create connection
	...
	$sql = "select * from problemtable where problemid=25";
	...
	<body>
		<script type="text/javascript">
			...
			function TryToLogin() {
				...
				var usercookie = "";
				var uk = "";
				var ck = getCookie("PHPSESSID");
				if(ck == "c4c8hdgd699dh8df7real6nnqf")
				{
					uk = "c4c8hdgd699dh8df7reak6nnqf";
				}
				else
				{
					uk = ck;
				...
				if ((username == adminnamecookie) && (userpwd == adminpswdcookie))
				{
					usercookie="c4c8hdgd699dh8df7real6nnqf";
				}
				else if((username == usernamecookie) && (userpwd == userpswdcookie))
				{
					usercookie = uk;
				}
				else{
				...
				document.cookie = "PHPSESSID" + "=" + (usercookie || "")  + expires + "; path=/";
				...
				fetch(cookieserverurl, {
						...
						{
							if(response.loginstatus !== 'AdminAccount')
							{
								var userdetails = "<font color=red>login sucessful, welcome "+ username+" but you are not a admin.<br>Redirecting to user page within 5 seconds </font>";
							...
							{
								var userdetails = "<font color=red>login sucessful, welcome "+ username+" but you are actually a admin. <br>Redirecting to admin page within 5 seconds </font>";
								document.getElementById("userdetailsdiv").innerHTML = userdetails;
								document.cookie = "user= ; expires = Thu, 01 Jan 1970 00:00:00 GMT;path=/;";
								sleep(7000).then(() => {
						...
						{
							var userdetails = "<font color=green>login sucessful, welcome  admin ("+ username +") your answer has been recorded successfully. Move to next Question or Attempt.<br>Redirecting to admin page within 5 seconds</font>";
							document.getElementById("userdetailsdiv").innerHTML = userdetails;
							document.cookie = "user= ; expires = Thu, 01 Jan 1970 00:00:00 GMT;path=/;";
							sleep(7000).then(() => {
							  window.location.href = "./adminpage.php";
				...
				<div class="col-md-9 body-content cnt-home" style="border-left: 1px solid black;">
					...
					<div class="row sign-in-page">
						...
						<div class="col-md-6 col-sm-6 sign-in">
							<h4 class="">sign in</h4>
							<p class="">Hello, please login to your account.(Admin username and password is : administrator/aDWIn  and Normal user username and password is : john/snow321)</p>
