...
// create connection
	...
	$sql = "select * from problemtable where problemid=2";
...
<html>
	<head>
		<title>Hack Me  - Search(Post)</title>
					...
					<div class="row">
								...
								<nav class="yamm megamenu-horizontal" role="navigation">
									<ul class="nav">
										<li class="dropdown menu-item">
											<a href="#" class="dropdown-toggle"><i class="icon fa fa-futbol-o fa-fw"></i>Footballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="#" class="dropdown-toggle"><i class="icon fa fa-hand-o-up fa-fw"></i>Volleyballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="#" class="dropdown-toggle"><i class="icon fa fa-send-o fa-fw"></i>Basketballs</a>
										</li>
										<li class="dropdown menu-item">
											<a href="#" class="dropdown-toggle"><i class="icon fa fa-spoon fa-fw"></i>Foods</a>
										</li>
									</ul>
								</nav>
							</div>
						...
						<div class="col-md-9">
							<?php
								...
								$whereclause = " where itemtype like '" . $itemtype . "'";
								$limitsql = " order by cc.cost DESC limit 20";
								...
								{
									$objectiveresult =  "Restricted Search term";
								}
								else
								{
									$result = $conn->query($sql);
								...
								'date' => date("Y-m-d"),
								'problemid' => $problemid,
								'problemname' => 'Search(post)',
								'problemstatus' => $objectiveresult
								);
								curl_logactivity($data);
								$_SESSION["logactivity"] = $_SESSION['uniquekey']." ".date("Y-m-d")." ".$objectiveresult." "."Search(post)";
								$conn->close();
