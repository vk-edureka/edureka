...
// create connection
	...
	$sql = "select * from problemtable where problemid=7";
		...
		<script type="text/javascript">
			function TryToLogin() {
				...
				var params = {
					...
					objective: "login",
					uniquekey: '<?php echo $_SESSION["uniquekey"]; ?>'
				};
				var fd = new FormData();
				...
				fetch(loginurl, {
						...
						{
							alert('Failed Login detected and reported! Details: ' + response.loginstatus);
						}
						else
						{							
							var userdetails = "<table border='1' class=table style=text-align:center;>";
							userdetails = userdetails + "<tr><th><i class='fa fa-user' aria-hidden='true'></i> User Id</th><td>" + response.userid +"</td></tr>";
							userdetails = userdetails + "<tr><th><i class='fa fa-user' aria-hidden='true'></i> Login ID</th><td>" + response.userlogin +"</td></tr>";
							userdetails = userdetails + "<tr><th><i class='fa fa-user' aria-hidden='true'></i> Name</th><td>" + response.username +"</td></tr>";
							userdetails = userdetails + "<tr><th><i class='fa fa-key' aria-hidden='true'></i> Password</th><td>" + response.userpwd +"</td></tr>";
							userdetails = userdetails + "<tr><th><i class='fa fa-book' aria-hidden='true'></i> Aadhar</th><td>" + response.aadharnumber +"</td></tr>";
							userdetails = userdetails + "<tr><th><i class='fa fa-certificate' aria-hidden='true'></i> Pan</th><td>" + response.pannumber +"</td></tr>";
							userdetails = userdetails + "<tr><th><i class='fa fa-clock-o' aria-hidden='true'></i> Age</th><td>" + response.age +"</td></tr>";
							userdetails = userdetails + "<tr><th><i class='fa fa-bug' aria-hidden='true'></i> Favorite Animal</th><td>" + response.favoriteanimal +"</td></tr></table>";
				...
				<div class="col-md-3" style="padding-left: 10px;height: 100%;border-right: 1px solid black;">
					...
					<div class="row">
						<div class="col-md-12">
								...
								<p>Enter in the same order as shown in the table and enter only value field separated by space. there will be no space in beginning and at the end</p>
