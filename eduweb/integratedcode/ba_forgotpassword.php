...
// create connection
	...
	$sql = "select * from problemtable where problemid=16";
	...
	<body>
		<script>
			function myFunction()
			{
				...
				var x = reseturl;
				var finalstring = "<a class="+"btn btn-primary"+" href="+x+" role="+"button"+">Click here to reset Password</a>";
				document.getElementById("userdetailsdiv").innerHTML = finalstring;
				return false;
			}
		</script>
		<div class="col-md-12">
				...
				<div class="col-md-9 body-content cnt-home" style="border-left: 1px solid black;">
					...
					<div class="row sign-in-page">
						...
						<div class="col-md-6 col-sm-6 sign-in">
							<h4 class="">sign in</h4>
							<p class="">Hello, please login to your account.(your username and password is: Sam/Sameer)</p>
							...
							<div>
								<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="Forgot Password" onclick="return myFunction()">Forgot Password</button>
							</div>
						</div>			
					</div>
					<div class="row">
						...
						<div class="col-md-8">
							<?php
								if(isset($_POST['userlogin']) && isset($_POST['userpwd']))
								{
									...
									if(($username == '') || ($userpwd == '') || ($username === false) || ($userpwd === false))
									{
										echo $message = "<font color=\"red\">Invalid username or password!</font>";
									}
									else
									{
										$sql = "select * from usermaptable where username = '" . $username . "' and password = '" . $userpwd . "'";
										$result = $conn->query($sql);

										if ($result->num_rows > 0) {
											echo "<font color=green><p>login successful !! Welcome ".$username." </p></font>";
										}
										else {
											echo $message = "<font color=\"red\">Invalid username or password!</font>";
										}
