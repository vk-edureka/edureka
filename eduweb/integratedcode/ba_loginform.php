	...
	<body>
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-3" style="padding-left: 10px;height: 100%;border-right: 1px solid black;">
					...
					<div class="row">
						<div class="col-md-12">
								...
								<p>Enter username and password separated by =(like abc=def without any space.mind the letter case)</p>
								<form method="post" style="text-align:center">
									<textarea name="answer" id="answer" rows="5" cols="30" placeholder="Enter your answer here" style="border-radius: 5px;"></textarea>									
									<br><br>
				...
				<div class="col-md-9 body-content" style="border-left: 1px solid black;">
							...
							<form class="register-form" method="post" onsubmit="return TryToLogin()">
								<div class="row" style="padding: 30px;">						
									<div class="form-group" style="align: center;">
										<div class="row">
											<label class="info-title" for="userlogin">Username <span>*</span></label>
										...
										<div class="row">						 										
											<label class="info-title" for="userpassword">Password <span>*</span></label>
							...
							<?php
								if(isset($_POST['userlogin']) && isset($_POST['userpwd']))
								{
									...
									if (($username == $what_name) && ($userpwd == $what_value))
									{
										...
										echo "<font color=green>welcome champ( ".$username." ) Login successful</font> ";
									}
									else
									{
